...
public interface IDisciplina_CursoSecundarioService
{
    ...
    Task<List<Disciplina_CursoSecundarioDTO>> GetByUtilizadorId(string identifier);
    Task<Disciplina_CursoSecundarioDTO> GetByUtilizadorDisciplina(string utilizadorId, string disciplinaCod);
